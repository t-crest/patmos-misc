...
# BB#0:                                      # %entry
	  ...
	  ( $p2) li	$r2 = 99                     #l1: iMax
	  ( $p2) mov	$r4 = $r0                #l1: i = 0
	  ( $p2) li	$r3 = _2                     #l1: r3 = &_2
	         pmov	$p4 =  $p2               #l1: whether the first loop should be run
.LBB0_1:                                     #l1: %for.cond
                                             #l1: =>This Inner Loop Header: Depth=1
	  ( $p4) cmplt	$p1 = $r2, $r4           #l1: 99<i <=> !(i<100)
	         pand	$p5 =  $p4, !$p1         #l1: p4 && i<100
	  ( $p5) lwc	$r5 = [$r3]              #l1: load _2
	         nop	
	  ( $p5) mul	$r4, $r5                 #l1: s2,s3 = i * _2 (low, high)
	  ( $p4) pmov	$p4 = !$p1               #l1: p4 = i<100
	  ( $p5) mfs	$r5 = $s2                #l1: r5 = i * _2 
	  ( $p4) br	.LBB0_1                      #l1: loop if i<100
	  ( $p5) add	$r1 = $r1, $r5           #l1: x += i * _2 (executes before branch)
	  ( $p5) add	$r4 = $r4, 1             #l1: i++         (executes before branch)
# BB#2:
	  ( $p3) mov	$r5 = $r0                #l2: i_2 = 0
	  ( $p3) li	$r4 = _3                     #l2: r4 = &_3
	  ( $p3) li	$r3 = 299                    #l2: iMax
	  ( $p3) li	$r2 = -1                     #l2: i = -1
	         pmov	$p4 =  $p3               #l2: whether the second loop should be run
.LBB0_3:                                     #l2: %for.cond2
